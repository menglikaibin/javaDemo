...
public class LowestCommonAncestor {
    ...
    private TreeNode ans(TreeNode node, TreeNode p, TreeNode q) {
        if (node == null) {
            return null;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lowestCommonAncestor.lowestCommonAncestor(treeNode, treeNode.left, treeNode.right));
    }
}
